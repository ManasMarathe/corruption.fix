...
import { activeFilterCount, defaultMapFilters, type MapFilters } from "@/lib/map-filters";
import { SERVICE_LIST } from "@/lib/services";
import { strings } from "@/lib/strings";

// Re-exported so existing importers (and any future ones) can keep reaching
// for the filter vocabulary through the panel that owns the UI for it. The
// definitions live in @/lib/map-filters so that map-url.ts and its tests can
// use them without importing a "use client" component.
export { defaultMapFilters, type MapFilters };
