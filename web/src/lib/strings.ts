...
export const strings = {
  ...
  map: {
    ...
    location: {
      ...
      inputPlaceholder: "e.g. Pune, Jaipur, Kerala",
      searching: "Searching…",
      noResults: "No places found. Try a city, district or state name.",
      failed: "Couldn't look that up right now. Please try again.",
      skip: "Show all of India",
      changeAriaLabel: "Change your area",
      setLocation: "Set your area",
    ...
    errors: {
      ...
      invalidPlaceQuery: "Enter at least three characters.",
      geocodeRateLimited: "Too many place lookups. Please wait a moment and try again.",
      geocodeUnavailable: "Place lookup is unavailable right now. Please try again.",
      serverError: "Something went wrong. Please try again.",
    },
  },
  chat: {
    launcherLabel: "Report via chat",
    ...
    send: "Send",
    thinking: "Thinking…",
    toolSearching: "Looking up offices…",
    toolDrafting: "Preparing your draft…",
    draftSuperseded: "Draft updated below.",
    close: "Close chat",
    retry: "Try again",
    review: {
      heading: "Review your report",
      body: "Check the details the assistant put together. You can edit anything before continuing — nothing is submitted yet.",
      officeLabel: "Office",
      continueButton: "Looks right — continue",
    },
    errors: {
      badOrigin: "Request rejected.",
      rateLimited: "You're sending messages too quickly. Please wait a bit and try again.",
      chatFailed: "The assistant couldn't respond. Please try again.",
      serverError: "Something went wrong. Please try again.",
    },
  },
  office: {
